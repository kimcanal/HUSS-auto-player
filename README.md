...
- Python 3.8+
- Google Chrome
- Selenium (ChromeDriver는 Selenium 4.6+에서 자동 관리됩니다.)
...
가상환경이 활성화된 상태에서 다음 명령어를 실행합니다. (설치는 최초 1회만 수행하면 됩니다.)

```bash
pip install -r requirements.txt
```

이 명령어는 프로젝트 실행에 필요한 Python 패키지인 **Selenium**을 자동으로 설치합니다.
